...
CATALOG: dict[str, str] = {
    ...
    # Blurbs must keep title + " — " + blurb ≤ 33 cells (one menu line);
    # French titles run long, so some blurbs trim harder than the English.
    "Top": "Top",
    "live throughput and sensors": "débits en direct, capteurs",
    "Connection": "Connexion",
    "fiber, IPv6, logs": "fibre, IPv6, journaux",
    "Wi-Fi": "Wi-Fi",
    "radios, networks, clients": "radios, réseaux, clients",
    "Devices": "Périphériques réseau",
    "who's on the network": "qui est là",
    "DHCP": "DHCP",
    "leases and reservations": "baux actifs et statiques",
    "Port forwarding": "Gestion des ports",
    "DMZ, UPnP": "DMZ, UPnP",
    "Downloads": "Téléchargements",
    "the download manager": "le gestionnaire",
    "Files": "Explorateur de fichiers",
    "browse the box's disks": "parcourir les disques",
    "Storage": "Disques",
    "disks and partitions": "disques et partitions",
    "Virtual machines": "VMs",
    "console, exec": "console, exécution",
    "Phone": "Téléphonie",
    "call log": "journal d’appels",
    "Contacts": "Contacts",
    "address book": "carnet d’adresses",
    "System": "Système",
    "sensors, reboot": "capteurs, redémarrage",
    # ---------- splash & dashboard ------------------------------------------
